...
import com.largehat.common.cache.utils.JsonKit;
...
public class RedisCache implements ICache {
	...
	public void putAll(List<JedisTemplate.Pair<String,Serializable>> values) {
		...
		try {
			List<JedisTemplate.PairEx<String,String,Integer>> pairDatas = new ArrayList<JedisTemplate.PairEx<String,String,Integer>>();
